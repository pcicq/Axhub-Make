...
const McpConnectivityIllustration: React.FC<McpConnectivityIllustrationProps> = ({ className = "" }) => {
  ...
  const integrations = [
    { name: "Figma", icon: "/pages/landing-page/images/mcp-integrations/figma.svg", installed: true },
    { name: "Shadcn UI", icon: "/pages/landing-page/images/mcp-integrations/shadcn.svg" },
    { name: "Next.js", icon: "/pages/landing-page/images/mcp-integrations/nextjs.svg", installed: true },
    { name: "Tailwind CSS", icon: "/pages/landing-page/images/mcp-integrations/tailwind-css.svg" },
    { name: "Resend", icon: "/pages/landing-page/images/mcp-integrations/resend.svg", installed: true },
    { name: "React", icon: "/pages/landing-page/images/mcp-integrations/react.svg" },
  ]
